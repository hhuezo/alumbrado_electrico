            ...
            <div class="xl:col-span-6 col-span-12 lg:col-span-7">
                <div class="card h-full">
                    <div class="card-header">
                        <h4 class="card-title">Evaluación de proyectos censo</h4>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function getConteoLuminaria() {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ URL::to('publico/evaluacion_proyectos/getConteoLuminariaCenso') }}",
                    data: parametros,
            ...
            function getGrafico() {
                ...
                $.ajax({
                    type: "get",
                    url: "{{ URL::to('publico/evaluacion_proyectos/getGraficoCenso/') }}/" + distrito,
                    success: function(response) {
                        //console.log(response);
