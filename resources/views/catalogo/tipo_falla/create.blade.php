            ...
            <div class="card">
                <div class="card-body flex flex-col p-6">
                    <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6 card-header">
                        <div class="flex-1">
                            <div class="card-title text-slate-900 dark:text-white">Tipo de falla

                                <a href="{{ url('catalogo/tipo_falla') }}">
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="xl:col-span-6 col-span-12 lg:col-span-6">
                                        ...
                                        @endif
                                        <form method="POST" action="{{ url('catalogo/tipo_falla') }}" enctype="multipart/form-data">
                                            @csrf
                                                ...
                                                <div class="grid pt-4 pb-3 px-4">
                                                    <div class="input-area relative">
                                                        ...
                                                        <input type="text" name="nombre"
                                                            value="{{ old('nombre') }}" required class="form-control">
                                                    </div>
                                                </div>
