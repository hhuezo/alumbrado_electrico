        ...
        <div class="card-body flex flex-col p-4">
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-7">
                <div class="input-area relative">
                    ...
                    <input type="text" readonly class="form-control" value="{{date('Y')}}">
                </div>
                <div class="input-area relative">
                    <label for="largeInput" class="form-label">Mes</label>
                    <input type="text" readonly class="form-control" value="{{$meses[date('m')]}}">
                </div>
                <div class="input-area">
                    <label for="largeInput" class="form-label">Distrito</label>
                    <div class="relative">
                        <input type="text" class="form-control !pr-12" placeholder="Todos" readonly >
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                            ...
                            <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="default_modal" tabindex="-1" aria-labelledby="default_modal" aria-hidden="true">
                                <div class="modal-dialog relative w-auto pointer-events-none">
                                    <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-paddingrounded-md outline-none text-current">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                                            ...
                                            <div class="p-6 space-y-4">
                                                <div>
                                                    ...
                                                    <select name="departamento" id="departamento" class="form-control w-full mt-2" onchange="getMunicipio(this.value)">
                                                ...
                                                <div>
                                                    ...
                                                    <select name="municipio" id="municipio" class="form-control w-full mt-2" disabled onchange="getDistrito(this.value)">
                                                ...
                                                <div>
                                                    ...
                                                    <select  id="distrito" class="form-control w-full mt-2" disabled>
                                            ...
                                            <div class="flex items-center justify-end p-6 space-x-2 border-t border-slate-200 rounded-b dark:border-slate-600">
                                                <button type="button" data-bs-dismiss="modal" class="btn inline-flex justify-center text-white bg-black-500" onclick="seleccione()">Aceptar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
