...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('template/css/jquery.bxslider.css') }} ">
        ...
        <div class="">
            <div class="bg-color">
                <header id="main-header">
                    <nav class="navbar navbar-default navbar-fixed-top" style="background-color: #1b3e62">
                        <div class="" style="margin-left: 50px;margin-right: 50px; height: 100px">
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="#"> <img src="{{ asset('img/logo-blanco.png') }}"
                                        style="width: 200px" alt="logo"></a>
                            </div>
                            <div class="collapse navbar-collapse" id="myNavbar">
                                <ul class="nav navbar-nav navbar-right">
                                    <li class="active"><a href="#main-header">Home</a></li>
                                    <li class=""><a href="#feature">Levantamiento de censo</a></li>
                                    <li class=""><a href="#service">Biblioteca</a></li>
                  ...
                  <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="#main-header">Home</a></li>
                    <li class=""><a href="#feature">Levantamiento de censo</a></li>
                    <li class=""><a href="#service">Estimación de factura</a></li>
                    <li class=""><a href="#portfolio">Evaluación de proyectos</a></li>
                    <li class=""><a href="#testimonial">Biblioteca</a></li>
                ...
                <div class="wrapper" style="background-color: #1b3e62">



                    <div style="background-color: #1b3e62">
                        <br><br><br><br>
                        <div class="container section-padding" style="background-color: #1b3e62">
                            <div class="row">
                                <div class="testimonial-item">
                                    <ul class="bxslider">
                                        <li>
                                            <blockquote>
                                                <img src="{{ asset('template/img/thumb.png') }}" class="img-responsive">
                                                <p>Come a day there won't be room for naughty men like us to slip about
                                                    at all. This job goes south, there well may not be another. </p>
                                            </blockquote>
                                        ...
                                        <li>
                                            <blockquote>
                                                <img src="{{ asset('template/img/thumb.png') }}"
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="wrap-item text-center">
                                    <div class="item-img">
                                        <img src="{{ asset('img/estadistica.png') }}" style="height:100px">
                                    </div>
                                    <h3 class="pad-bt15">Estadistica de atención</h3>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="wrap-item text-center">
                                    <div class="item-img">
                                        <img src="{{ asset('img/informe.png') }}" style="height:100px">
                                    </div>
                                    <h3 class="pad-bt15">Informes</h3>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="wrap-item text-center">
                            <div class="item-img">
                                <img src="{{ asset('template/img/ser02.png') }}">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="wrap-item text-center">
                            <div class="item-img">
                                <img src="{{ asset('template/img/ser03.png') }}">
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="wrap-item text-center">
                            <div class="item-img">
                                <img src="{{ asset('template/img/ser04.png') }}">
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <br><br> <br><br>
                        <h2 class="service-title pad-bt15" style="color: #67696C">Biblioteca</h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
                        <figure>
                            <img src="{{ asset('template/img/port01.jpg') }}" class="img-responsive">
                            <figcaption>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
                        <figure>
                            <img src="{{ asset('template/img/port02.jpg') }}" class="img-responsive">
                            <figcaption>
                                <h2>Project For Everyone</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nost.</p>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
                        <figure>
                            <img src="{{ asset('template/img/port03.jpg') }}" class="img-responsive">
                            <figcaption>
                                <h2>Project For Everyone</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nost.</p>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
                        <figure>
                            <img src="{{ asset('template/img/port04.jpg') }}" class="img-responsive">
                            <figcaption>
                                <h2>Project For Everyone</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nost.</p>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
                        <figure>
                            <img src="{{ asset('template/img/port05.jpg') }}" class="img-responsive">
                            <figcaption>
                                <h2>Project For Everyone</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nost.</p>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
                        <figure>
                            <img src="{{ asset('template/img/port06.jpg') }}" class="img-responsive">
                            <figcaption>
                                <h2>Project For Everyone</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nost.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-sec">
                            <div class="blog-img">
                                <a href="">
                                    <img src="{{ asset('template/img/blog01.jpg') }}" class="img-responsive">
                                </a>
                            </div>
                            <div class="blog-info">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-sec">
                            <div class="blog-img">
                                <a href="">
                                    <img src="{{ asset('template/img/blog02.jpg') }}" class="img-responsive">
                                </a>
                            </div>
                            <div class="blog-info">
                                <h2>This is Lorem ipsum heading.</h2>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="blog-sec">
                            <div class="blog-img">
                                <a href="">
                                    <img src="{{ asset('template/img/blog03.jpg') }}" class="img-responsive">
                                </a>
                            </div>
                            <div class="blog-info">
                                <h2>This is Lorem ipsum heading.</h2>
